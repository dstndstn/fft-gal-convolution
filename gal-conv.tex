...
% - check for best Lupton-deV and Lupton-exp mixture components
...
\begin{tabular}{cdddd}
\hline
\textbf{Component} & \multicolumn{2}{c}{\textbf{Exponential}} & 
\multicolumn{2}{c}{\textbf{deVaucoulers}} \\
& \multicolumn{1}{c}{Amplitude}
& \multicolumn{1}{c}{Variance}
& \multicolumn{1}{c}{Amplitude}
& \multicolumn{1}{c}{Variance} \\
\hline
1 & 
