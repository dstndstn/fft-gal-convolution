...
% --in the intro, should I identify the ``problems'' and mention that
%   we are going to solve them with our method??

% - General Sersic models?!
%   (another improvement over GalSim)

% - talk about the possibilty of using PSF models sampled at other
%   than the native pixel grid, as per Schlegel's comments


%\documentclass[11pt,letterpaper,preprint]{aastex}
...
\author{Dustin Lang} %~Lang\altaffilmark{1,2,3}}
\affiliation{%
