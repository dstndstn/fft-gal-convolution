...
% - discuss switching from Fourier to real space to avoid aliasing
%   (this is a way in which this has an advantage over GalSim, I think)
...
Step 5 is the core of the \trick.  The Fourier transform of
